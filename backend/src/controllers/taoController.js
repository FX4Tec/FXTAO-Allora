...
const TAO_ALLOWED_FIELDS = [
    ...
    'tax_cbs_percent', 'tax_ibs_percent', 'split_payment_enabled',
    ...
    'financial_construction_company_text', 'financial_business_area_text',
    'default_financial_bank_account_text', 'billing_issue_bank_account_text',
